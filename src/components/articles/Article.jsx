		...
		<div className="col-md-9 card bg-light border border-dark p-1 mb-3 mx-auto">
			...
			>
				<div className="card-header bg-transparent">
					<div className="row">
						<div className="col col-sm-1">
							<img src={article.author.image} alt="" className="rounded-circle w-75 border ml-2" />
						</div>
						<div>
							<span className="font-weight-bold">{article.author.username}</span>
							<br />
				...
				<div className="card-body">
					<div className="card-text font-weight-bold text-center ml-4">{article.title}</div>
					<div className="row">
			...
			<div className="likecontainer">
				...
				<i className="fa fa-thumbs-down fa-2x " /> {article.dislike}
			</div>
		</div>
	</div>
);
