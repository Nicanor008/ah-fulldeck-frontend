...
export const FOLLOW_USER_REQUEST = 'FOLLOW_USER';
export const FOLLOW_USER_SUCCESS = 'FOLLOW_USER';
export const FOLLOW_USER_FAILURE = 'FOLLOW_USER';
export const UNFOLLOW_USER_REQUEST = 'FOLLOW_USER';
export const UNFOLLOW_USER_SUCCESS = 'FOLLOW_USER';
export const UNFOLLOW_USER_FAILURE = 'FOLLOW_USER';
export const GET_FOLLOWING = 'GET_FOLLOWING';
export const GET_LOGGED_IN_USER_FOLLOWING = 'GET_LOGGED_IN_USER_FOLLOWING';
